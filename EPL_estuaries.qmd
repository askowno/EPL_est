...
write.csv(est, file = "outputs/est_pa_metrics290.csv")
```
...
# 2018 metrics
   ...
   mutate(prp_pa18_model = (A18 + B18 + (0.3*(C18+D18))  + (0.1*E18))/tot_ext18) %>%
...
# 2024 metrics   
   ...
   mutate(prp_pa24_model = (A + B + (0.3*(C+D)) + (0.1*E))/tot_ext18) %>%
